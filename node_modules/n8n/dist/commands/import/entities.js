...
const flagsSchema = zod_1.z.object({
    inputDir: zod_1.z
        ...
        .default('./outputs'),
    truncateTables: zod_1.z.boolean().describe('Truncate tables before import').default(false),
});
let ImportEntitiesCommand = class ImportEntitiesCommand extends base_command_1.BaseCommand {
    async run() {
        ...
        await di_1.Container.get(import_service_1.ImportService).importEntities(inputDir, truncateTables);
    }
    catch(error) {
