...
__export(description_exports, {
  planAndExecuteAgentProperties: () => planAndExecuteAgentProperties
});
module.exports = __toCommonJS(description_exports);
var import_prompt = require("./prompt");
const planAndExecuteAgentProperties = [
  {
    displayName: "Text",
    name: "text",
    type: "string",
    ...
    options: [
      {
        ...
        type: "string",
        default: import_prompt.DEFAULT_STEP_EXECUTOR_HUMAN_CHAT_MESSAGE_TEMPLATE,
